...
5. "is_academic": 布尔值，判断是否为学术文献（true/false）。学术文献包括：期刊论文、会议论文、学位论文、预印本、技术报告等。非学术文献包括：产品说明书、用户手册、合同、表格、通知、广告等
6. "citation": APA第7版引用格式，包含作者、年份、标题、期刊/会议名、卷号、页码、DOI等。如无法提取足够信息则输出"unknown"
